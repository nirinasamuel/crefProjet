  ...
  <ul class="pagination pagination-sm">
   <c:choose>
     ...
     <li class="page-item disabled">
      ...
      <a class="page-link" href="${ base_url }/anomalie?page=1">Début</a>
    </li>
    <c:choose>
     <c:when test="${currentPage eq 1}">
     <li class="page-item disabled">
      ...
      <a class="page-link" href="${ base_url }/anomalie?page=${currentPage-1}" aria-label="Previous">
    ...
    <c:forEach begin="${start}" end="${end}" var="i">
      ...
      <span class="page-link">
        ...
        <span class="sr-only">(current)</span>
                    ...
                    <c:otherwise>
                    <li class="page-item"><a class="page-link" href="${ base_url }/anomalie?page=${i}">${i}</a></li>
     ...
     <c:choose>
      ...
      <a class="page-link" href="${ base_url }/anomalie?page=${currentPage+1}" aria-label="Next">
     ...
     <li class="page-item disabled">
      ...
      <a class="page-link" href="${ base_url }/anomalie?page=${noOfPages}">Fin</a>
    </li>
  </ul>
</nav>
                                    ...
                                    <div class="box box-danger">
                                        ...
                                        <div class="box-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input id="moyenne" name="moyenne" placeholder="moyenne" class="form-control" type="number" min="0" max="20" value="${etudiant.moyenne}"/>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input id="num_bacc" name="num_bacc" placeholder="num_bacc" class="form-control" type="number" min="0" value="${etudiant.num_bacc}"/>
                                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <label>Mathémathiques:</label>

                                                    <div class="input-group ">
                                                        <div class="input-group-addon">
                                                            <i class="fa fa-id-card-o"></i>
                                                        </div>
                                                        <input id="math" name="math" placeholder="note de math" class="form-control" type="number" min="0" max="20" value="${etudiant.math}"/>
                                                    </div>
                                                    ...
                                                    <div class="input-group ">
                                                        ...
                                                        <input id="pc" name="pc" placeholder="note de pc" class="form-control" type="number" min="0" max="20" value="${etudiant.pc}"/>
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input id="sn" name="sn" placeholder="note de svt" class="form-control" type="number" min="0" max="20" value="${etudiant.sn}"/>
                                                    </div>
