                ...
                <div class="row bg-white has-shadow">
                    ...
                    <div class="col-xl-3 col-sm-6">
                        <div class="item d-flex align-items-center">
                            ...
                            <div class="icon"><a href="${ base_url }/pdf_derogation?choix=MI">pdf</a></div>
                        </div>
                    </div>
                    <!-- Item -->
                    <div class="col-xl-3 col-sm-6">
                        <div class="item d-flex align-items-center">
                            ...
                            <div class="icon"><a href="${ base_url }/pdf_derogation?choix=PC">pdf</a></div>
                        </div>
                    </div>
                    <!-- Item -->
                    <div class="col-xl-3 col-sm-6">
                        <div class="item d-flex align-items-center">
                            ...
                            <div class="icon"><a href="${ base_url }/pdf_derogation?choix=SVT">pdf</a></div>
                        </div>
                    </div>
                    <!-- Item -->
                    <div class="col-xl-3 col-sm-6">
                    ...
                    <div class="col-lg-12 col-sm-12 col-md-12">
                        <div class="card">
                            ...
                            <div class="card-header d-flex align-items-center">
                                <h3 class="h4">Dérogation</h3>
                            </div>
                            <div class="card-body">
                                <form class="form-horizontal" method="post" action="search_derogation">
