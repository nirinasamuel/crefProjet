...
@WebServlet("/excel_selection")
public class ExcelResultatCritereServlet extends BaseServlet {
	private static final long serialVersionUID = 1L;
    private CandidatDao candidatDao;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ExcelResultatCritereServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			this.getServletContext().getRequestDispatcher("/pdf/result.csv").forward(request, response);
		}
