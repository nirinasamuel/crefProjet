...
@WebServlet("/pdf_resultat_selection")
public class PdfResultatSelectionServlet extends BaseServlet {
	private static final long serialVersionUID = 1L;
    private CandidatDao candidatDao;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PdfResultatSelectionServlet() {
        super();
	...
	public void createPdf(String dest, List<Candidat> candidats, int id_vague) throws IOException, DocumentException {
        ...
        Paragraph titre=new Paragraph("    Liste des étudiants sélectionnés en L1 - "+candidats.get(0).getChoix(),font2);
         String textList="";
        if(id_vague==1)
      ...
      //  document.add(new Paragraph("  ",font1));
       ...
       // document.add(new Paragraph("  ",font1));
        ...
        document.add(new Paragraph("  Les anciens bacheliers sélectionnés en 1ère année (formation à vocation académique ou professionnalisante) ne bénéficieront pas des allocations de bourse d'études.",font2));
        //document.add(new Paragraph("  ",font1));
