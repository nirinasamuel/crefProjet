 ...
 * 
 */
@WebServlet("/preinscription_en_ligne")
public class CandidatInscritsEnLigne extends BaseServlet {
     ...
     */
    public CandidatInscritsEnLigne() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			boolean valid = (urlDao.validAccess(session, "/preinscription_en_ligne"));
			if(valid == false)
			{
